...
insert into file_info (id, file_na
me, save_file_name, content_type, delete_flag, create_date, modify_date ) values ( 188,'50_ma_129.png', 'img/50_ma_129.png', 'image/png', 0, now(), now());
